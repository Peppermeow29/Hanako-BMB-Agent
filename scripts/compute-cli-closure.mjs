...
export const RUNTIME_ASSETS = Object.freeze([
  ...
  {
    path: "scripts/minicpm5-mlx-server.mjs",
    kind: "file",
    reason:
      "lib/providers/minicpm5-runtime.ts resolves and spawns this launcher when the local "
      + "MiniCPM5 endpoint is unavailable in a packaged server.",
  },
  {
    path: "scripts/minicpm5_mlx_server.py",
    kind: "file",
    reason:
      "scripts/minicpm5-mlx-server.mjs launches this MLX-LM HTTP server as the packaged "
      + "MiniCPM5 local runtime entrypoint.",
  },
]);
