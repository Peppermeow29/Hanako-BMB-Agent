...
const BUILT_IN_SETTINGS_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    tabId: 'speech-recognition',
    titleKey: 'settings.media.speechRecognition',
    pathKeys: ['settings.media.speechRecognition'],
    aliases: ['speech recognition', 'voice', 'transcription', '语音识别', '转录'],
  },
  {
