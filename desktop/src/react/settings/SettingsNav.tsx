...
const TAB_ITEMS = [
  ...
  { id: 'speech-recognition', key: 'settings.media.speechRecognition', d: '<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M5 10v2a7 7 0 0 0 14 0v-2"/><path d="M12 19v3"/><path d="M8 22h8"/>' },
