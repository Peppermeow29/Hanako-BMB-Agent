...
const TAB_TITLE_KEYS: Record<string, string> = {
  ...
  'speech-recognition': 'settings.media.speechRecognition',
...
function normalizeSettingsTab(tab: string): string {
  ...
  // Existing deep links to the removed media-generation page retain the
  // still-supported voice-transcription settings instead of landing blank.
  return tab === 'media' ? 'speech-recognition' : tab;
}
