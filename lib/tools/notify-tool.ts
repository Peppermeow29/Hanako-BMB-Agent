...
const NOTIFY_BRIDGE_PLATFORMS = new Set(["wechat", "feishu"]);
...
export function createNotifyTool({ onNotify }) {
  return {
    ...
    parameters: Type.Object({
      ...
      bridgePlatforms: Type.Optional(Type.Array(StringEnum(["wechat", "feishu"], {
