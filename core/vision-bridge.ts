...
const AUXILIARY_VISION_SYSTEM_PROMPT = [
  ...
  "Your role is visual transcription and grounding for a text-only target model, not final problem solving.",
  "For math, science, or word-problem images, transcribe the complete statement, formulas, labels, and diagram relationships; do not derive or guess the final answer.",
  "For UI or document images, report only task-relevant visible evidence, text, layout, and coordinates.",
  "The target model is responsible for the final answer after it receives your note.",
...
function formatStructuredVisionNote(analysis, visionCapabilities) {
  ...
  const sections = [
    ...
    `task_relevant_transcription: ${safeSection(analysis?.task_relevant_transcription)}`,
...
function formatInvalidStructuredNote(rawResponse) {
  ...
  return truncate([
    ...
    "task_relevant_transcription: unavailable.",
        ...
        content: [
          {
            ...
            text: [
              ...
              "task_relevant_transcription: for math/science problems, transcribe the complete statement, formulas, labels, and diagram relationships; otherwise list task-relevant visible text and layout.",
              "user_request_answer: state only the visual evidence relevant to the request; do not solve math/science problems or provide a guessed final answer.",
        ...
        content: [
          {
            ...
            text: [
              ...
              '  "task_relevant_transcription": "complete problem statement, formulas, labels, and diagram relationships when present",',
              '  "user_request_answer": "visual evidence relevant to the request; do not solve math/science problems",',
