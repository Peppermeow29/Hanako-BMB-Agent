 ...
 *   { type: "content_block", block: { type: "file"|"artifact"|"screenshot"|"skill"|"plugin_card"|"suggestion_card"|"cron_confirm"|"settings_confirm"|"settings_update", ... } }  (工具结果统一内容块，含 stage_files、旧 create_artifact 兼容输出、browser screenshot、install_skill/plugin card、建议卡片、cron 兼容确认和设置结果)
